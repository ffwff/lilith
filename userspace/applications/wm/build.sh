build() {
  LDFLAGS="-I$opt_toolsdir/include -L$opt_toolsdir/lib $script_dir/painter/c/alpha_blend.c -lpng -lz -lm -msse2" $script_dir/compile $script_dir/wmcr.cr $build_dir/wmcr
