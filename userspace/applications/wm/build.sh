...
build() {
    ...
    ${opt_arch}-gcc -g -o $build_dir/cterm $script_dir/cterm.c -I$opt_toolsdir/include -L$opt_toolsdir/lib -lm -lcanvas -lgui -lwmc -msse2
    # ${opt_arch}-gcc -g -o $build_dir/canvwin $script_dir/canvwin.c -I$opt_toolsdir/include -L$opt_toolsdir/lib -lm -lcanvas -msse2
