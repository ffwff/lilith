...
module VGADevice
  ...
  private module Unlocked
    ...
    @@cx = 0
    @@cy = 0
    @@fg = VGADevice::Color::White
    @@bg = VGADevice::Color::Black
    class_property cx
    class_property cy
    class_property fg
    class_property bg
  ...
  struct Instance < OutputDriver
    private def color_code(fg : VGADevice::Color, bg : VGADevice::Color, char : UInt8) : UInt16
    ...
    def initialize
      enable_cursor 0, 1
      # fill with blank
      blank = color_code VGADevice::Color::White, VGADevice::Color::Black, ' '.ord.to_u8
      VGADevice.lock do |state|
    ...
    private def putc(state, x : Int32, y : Int32, fg : VGADevice::Color, bg : VGADevice::Color, a : UInt8)
